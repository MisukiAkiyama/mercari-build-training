...
The environment within the docker image should be the same as STEP5-2 after STEP5-5.
...
[STEP7: Implement a simple Mercari webapp as frontend](07-frontend.en.md)